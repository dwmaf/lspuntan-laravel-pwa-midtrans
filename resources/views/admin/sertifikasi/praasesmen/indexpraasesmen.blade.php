<x-admin-layout>
    ...
    <div class="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
        ...
        <form action="/rincian_praasesmen/{{ $sertification->id }}/update" class="mt-4 flex flex-col gap-2" method="POST"
            ...
            <input type="file" name="praasesmen_attachment_file[]" multiple
