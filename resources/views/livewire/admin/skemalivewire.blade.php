                            ...
                            <tr>
                                ...
                                <td class="text-gray-700 dark:text-gray-200 px-4 py-2 text-center">
                                    <div class="flex items-center justify-center space-x-2">
                                        ...
                                        <x-edit-button wire:click="edit({{ $skema->id }})">Edit</x-edit-button>
                                        
                                        <x-delete-button wire:click="destroy({{ $skema->id }})" wire:confirm="Apakah Anda yakin ingin menghapus skema ini?">Hapus</x-delte-button>
    ...
    @if ($formMode === 'edit')
        ...
        <div
            ...
            <div class="p-6 border-b dark:border-gray-700">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Edit Skema Sertifikasi</h3>
            </div>
