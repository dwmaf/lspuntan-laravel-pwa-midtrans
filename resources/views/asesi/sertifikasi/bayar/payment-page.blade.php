            ...
            <div class="p-6 md:p-8 border-b border-gray-200 dark:border-gray-700">
                ...
                <div class="flex justify-between items-start mb-6">
                    <div>
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Silakan periksa kembali rincian di bawah
                            ini sebelum melanjutkan.</p>
                    </div>
                    <div class="text-right">
                        {{-- Gunakan ID transaksi sebagai nomor invoice yang unik dan konsisten --}}
                        <p class="text-sm font-semibold text-gray-700 dark:text-gray-300">INVOICE #{{ $transaction->id }}
                        </p>
                        <p class="text-sm text-gray-500 dark:text-gray-400">Tanggal:
                ...
                <div class="w-full overflow-x-auto">
                    <table class="min-w-full text-left text-sm">
                        <thead class="border-b border-gray-200 dark:border-gray-700">
                            <tr>
                                <th scope="col" class="font-semibold text-gray-800 dark:text-gray-200 py-2">Deskripsi
                                </th>
                                <th scope="col"
                                    class="font-semibold text-gray-800 dark:text-gray-200 py-2 text-right">Total</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="border-b border-gray-200 dark:border-gray-700">
                                <td class="py-4 text-gray-700 dark:text-gray-300">
                                    ...
                                    @if (isset($sertification))
                                        <span
                                            class="block text-xs text-gray-500">{{ $sertification->skema?->nama_skema }}</span>
                                    @endif
                                </td>
                                <td class="py-4 font-medium text-gray-900 dark:text-white text-right">
                                    Rp{{ number_format($sertification->harga, 0, ',', '.') }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
