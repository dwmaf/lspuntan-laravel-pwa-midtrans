...
// 4. Fungsi untuk masuk/keluar mode edit
const enterEditMode = () => {
    ...
    form.batas_pengumpulan_tugas_asesmen = batas ? new Date(batas).toISOString().slice(0, 16) : null;
...
// Cek saat komponen dimuat, jika belum ada rincian, langsung masuk mode edit
onMounted(() => {
...
// 6. Fungsi untuk menghapus file
const deleteFile = (sert_id,id_file) => {
    if (confirm('Yakin ingin menghapus lampiran ini?')) {
        router.delete(route('admin.sertifikasi.asesmen.file.destroy', [sert_id, id_file]), {
            preserveScroll: true,
        });
    }
};
...
<template>
    <AdminLayout>
        ...
        <div v-if="!isEditing" class="py-3 px-5 bg-white dark:bg-gray-800 rounded-lg shadow-md mb-2">
                ...
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <div>
                        ...
                        <div class="text-xs text-gray-400">
                            {{ props.sertification.tanggalRincianAsesmenDibuatFormatted }}
            ...
            <div v-html="props.sertification.rincian_tugas_asesmen.replace(/\n/g, '<br>')"
            ...
            <div class="flex">
                ...
                <dd class="text-sm text-gray-900 dark:text-gray-100">
                    {{ props.sertification.batasPengumpulanFormatted || '-' }}
                </dd>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-2 mt-2">

                <div v-for="file in props.sertification.tugasasesmenattachmentfile" :key="file.id"
                ...
                <p v-if="!props.sertification.tugasasesmenattachmentfile.length" class="text-xs text-gray-500">Tidak ada
                    lampiran.</p>
        ...
        <div v-else class="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md flex flex-col gap-2">
            ...
            <form @submit.prevent="submit" class="flex flex-col gap-4">
                <div>
                    ...
                    <textarea v-model="form.rincian_tugas_asesmen" rows="8" class="mt-1 w-full text-sm p-3 border border-gray-300 dark:border-gray-700 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:bg-gray-900 dark:text-gray-100"></textarea>
                    <InputError :message="form.errors.rincian_tugas_asesmen" />
                </div>
                <div>
                    <InputLabel value="Batas Pengumpulan" />
                    <TextInput type="datetime-local" v-model="form.batas_pengumpulan_tugas_asesmen" />
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-2 mb-2">
                        ...
                        <div v-for="file in props.sertification.tugasasesmenattachmentfile" :key="file.id"
                            ...
                            <button @click.prevent="deleteFile(file.id)" type="button"
                    ...
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tr v-for="(asesi, index) in props.filteredAsesi" :key="asesi.id"
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                ...
                                <Link v-if="asesi.asesiasesmenfiles.length" :href="route('admin.sertifikasi.rincian.assessment.asesi.index', { sert_id: props.sertification.id, asesi_id: asesi.id })"
