...
console.log(props.listPengumuman);
    ...
    <AsesiLayout>
            ...
            <div v-if="props.listPengumuman.length > 0" class="space-y-4">
                <div v-for="pengumuman in props.listPengumuman" :key="pengumuman.id"
                    ...
                    <div class="flex flex-wrap items-start justify-between gap-3 mb-3">
                        ...
                        <StatusBadge v-if="pengumuman.is_certif_news" variant="success">
        ...
        <div class="max-w-3xl mx-auto" v-if="showMode === 'show' && selectedPengumuman">
            <div class="py-3 px-5 bg-white dark:bg-gray-800 rounded-lg shadow-md">
                <BackButton @click="showList" class="mb-4" />
                
                <div class="flex flex-wrap items-start justify-between gap-3 mb-3">
                    <CreatorInfo :name="selectedPengumuman.user?.name || 'Admin'"
                        :created-at="selectedPengumuman.created_at" :updated-at="selectedPengumuman.updated_at" />
                    <StatusBadge v-if="selectedPengumuman.is_certif_news" variant="success">
                        Pengumuman Pengambilan Sertifikat
                    </StatusBadge>
                </div>
