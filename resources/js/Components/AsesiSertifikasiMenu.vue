        ...
        <div class="flex flex-wrap gap-4 mt-1">
            <div>
                <template v-if="isDetailEnabled">
                    ...
                    <div v-if="routeActive('asesi.sertifikasi.applied.show')" style="margin-top:-4px"
                        class="w-full h-1 bg-gray-300 dark:bg-gray-700 rounded-t-md"></div>
                </template>
                <template v-else>
                    <div
                        class="flex items-center gap-2 px-4 py-3 font-semibold text-sm rounded-t-md dark:text-gray-200 text-slate-400">
            ...
            <div>
                <template v-if="isPengumumanEnabled">
                    ...
                    <div v-if="routeActive('asesi.pengumuman.index')" style="margin-top:-4px"
                        class="w-full h-1 bg-gray-300 dark:bg-gray-700 rounded-t-md"></div>
                </template>
                <template v-else>
                    <div
            ...
            <div>
                <template v-if="isAsesmenEnabled">
                    ...
                    <div v-if="routeActive('asesi.assessmen.index')" style="margin-top:-4px"
                        class="w-full h-1 bg-gray-300 dark:bg-gray-700 rounded-t-md"></div>
                </template>
                <template v-else>
