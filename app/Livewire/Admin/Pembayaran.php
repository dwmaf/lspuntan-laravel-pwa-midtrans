                ...
                if ($user = $asesi->student->user) {
                    ...
                    if ($user->fcm_token) {
                        ...
                        try {
                            ...
                            Log::error("Gagal mengirim notifikasi rincian pembayaran ke user {$user->id}: " . $e->getMessage());
                        }
                    }
                    Notification::send($user, new RincianPembayaranUpdated($this->sertification, $asesi));
                }
            }
        }
